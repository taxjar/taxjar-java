...
We recommend installing taxjar-java with [Maven](https://maven.apache.org/what-is-maven.html). Before authenticating, [get your API key from TaxJar](https://app.taxjar.com/api_sign_up/plus/).
